...
- Alpine, Ubuntu, Debian, CentOS, Rocky Linux, Amazon Linux, RHEL, Oracle Linux, SUSE Enterprise Linux and Raspbian, FreeBSD
...
- Offline mode scan with no internet access. (Red Hat, CentOS, Rocky Linux,OracleLinux, Ubuntu, Debian)

[Fast Root Scan](architecture-fast-root-scan.md)

- Scan with root privilege
- Almost no load on the scan target server
- Detect processes affected by update using yum-ps (Red Hat, CentOS, Rocky Linux, Oracle Linux and Amazon Linux)
